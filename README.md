...
**Dev Notes**
15.08 - получил задание, продумал структуру и пока планирую созать классический сервис состоящий из repository (СRUD), service, handlers. В работе планирую использовать Echo Frame Work, golangci-lint, docker, а так же Юнит и Интеграционные тесты.